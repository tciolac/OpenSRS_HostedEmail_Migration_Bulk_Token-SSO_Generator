...
#Purpose: Creates a CSV. Column one contains a list of target email addresses provided by the user. Column two will include a Single Sign On (SSO) password, or Multi-Use Time Based Token. Additional options include a secondary SSO in collumn three.
